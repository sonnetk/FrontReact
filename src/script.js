...
//
// Текущее задание:
// Изучить функциональный подход к написанию компонентов. Написать функциональные компоненты с вложенностью одного в другой. Использовать паттерн renderProps в функциональном подходе.
